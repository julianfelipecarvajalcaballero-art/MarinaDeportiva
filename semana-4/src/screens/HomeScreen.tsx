...
export default function HomeScreen() {
  ...
  const handleSaveToggle = useCallback(
    (item: MarinaItem) => {
      ...
      isSaved ? removeItem(item.id) : addItem(item);
    },
...
const styles = StyleSheet.create({
  ...
  searchContainer: {
    ...
    borderRadius: 12, paddingHorizontal: SPACING.md, height: 48,
  ...
  saveButtonText: { ...TYPOGRAPHY.body, color: COLORS.primary, fontWeight: '600' },
  savedButtonText: { color: COLORS.error },
});
